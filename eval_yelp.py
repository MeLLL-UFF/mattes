...
class Config():
    ...
    dev_src_file0 = 'data/yelp/cleaned_test_li0.txt'
    dev_src_file1 = 'data/yelp/cleaned_test_li1.txt'
    dev_trg_file = 'data/yelp/dev.attr'
    dev_trg_file0 = 'data/yelp/test_0.attr'
    dev_trg_file1 = 'data/yelp/test_1.attr'
    ...
    translate = False
    ckpt = '3500_F.pth'
    model_name = 'best_model_yelp'
    beam_size = 1
    valid_file_0 = 'save/best_yelp_b3/best_yelp_b3_0'#'baseline_outputs/shakespeare/strap/cleaned_0to1'    
    valid_file_1 = 'save/best_yelp_b3/best_yelp_b3_1'#'baseline_outputs/shakespeare/strap/cleaned_1to0' 
