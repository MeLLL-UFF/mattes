...
#Here, the data object passed is from Datautil2 class
...
#Here, the data object passed is from Datautil class
def lm_ppl(model, data, batch_size, test_src_file, test_trg_file):
  model.eval()
  report_words = report_loss = report_ppl = report_sents = 0
